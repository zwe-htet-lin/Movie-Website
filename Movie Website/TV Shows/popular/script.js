...
// Show movies on body
const url = "https://api.themoviedb.org/3/tv/popular?api_key=845e81600d9d504ee9e6e2f1b08dee9f&page=1";
...
back.addEventListener("click", () => {
    ...
    if(array[array.length-2].mediaType === "" && array[array.length-2].tmdbId === "" && array[array.length-2].searchText === ""){
        ...
        headingH1.innerHTML = "Popular TV Shows";
...
next.addEventListener("click", () => {
    ...
    if(movieContainer.getAttribute("search-text") === null){
        const url = `https://api.themoviedb.org/3/tv/popular?api_key=845e81600d9d504ee9e6e2f1b08dee9f&page=${index}`;
        showMovies(url);
    }else{
